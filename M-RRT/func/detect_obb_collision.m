...
%% link_axis is  2 * 2 cells, each cell is 1 by 2 vector; first row of cells corresponding to one link's two parallel axes
%% so  link_axis{1,1}  is  1 axis of link 1, and  link_axis{1,2} is second axis of link 1
