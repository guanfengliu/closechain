function [start_config,end_config]=GenerateValidStartEndNarrow(linklength,thickNess,CollisionVarCritRadiusL,CollisionVarCritRadiusR,polyObst, obst, pos_left,pos_right,j_start,j_end, numPair)
