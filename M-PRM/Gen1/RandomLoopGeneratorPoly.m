function [out, b_samples] = RandomLoopGeneratorPoly(linklength,CollisionVarCritRadiusL,CollisionVarCritRadiusR,enable_bound,left_2_right,n_samples,initAngle)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% modular function for random loop configuration sampling, this is
% different from J. Cortes's RLG
...
%left_2_right, true, we use CollisionVarCritRadiusL to compute the range of
%joint angles; false, we use CollisionVarCritRadiusR to compute the range
...
% @n_samples, the number of samples to be gerenated that satisfies the
