...
close all, clear all
%% link lengths
linklength=[3.2000, 2.0000, 2.5457, 1.2, 4.5684, 4, 7.5815];
...
startc(:,2) = [0.8876, -0.1414, -1.2786, 1.4988, -1.0427, 3.1416]';
...
nobst_samples=20; %%10;  %% c-obst samples in each iteration
enable_bound=true;
if enable_bound
    strBound = 'wbound';
else
