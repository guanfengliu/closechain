function print2dCspaceAndBound(mpData, o_final_traj, roadmap, mpeg_id, start_config, end_config)
linklength = mpData.linklength;
obst = mpData.obst;
BoundVarCritRadiusL = mpData.CollisionVarCritRadiusL;
BoundVarCritRadiusR = mpData.CollisionVarCritRadiusR;
bound_samples = mpData.bound_samples;
obst_samples = mpData.obst_samples;
